...
#     --eps1 0.0005\
#     --lamb 1.0\
#     --model_path "PATH/InternVL3_5-2B-HF/"\
...
python AGDI_intern3_5VL.py \
    ...
    --eps1 0.0005\
    --lamb 1.0\
    --model_path "/data/xcw/model/InternVL3_5-2B-HF/"\
    --data_json_path "/data/xcw/dataset/PLA_prune/mydataset/special_merge1000.json"\
    --output "/data/xcw/dataset/PLA_prune/5pair_combine100/PLA/ADGI_intern3_5VL_update_all_hf_layer" \
